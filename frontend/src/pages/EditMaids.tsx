          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
            {paginatedMaids.map((maid, i) => {
              ...
              return (
                ...
                >
                  <div
                    className="flex h-28 w-24 cursor-pointer items-center justify-center rounded-md border bg-muted text-xs text-muted-foreground transition-all hover:ring-2 hover:ring-primary/40"
