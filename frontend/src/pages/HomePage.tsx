...
const HomePage = () => {
  ...
  const statRow1: [string, string][] = [
    ...
    ["#0D6E56", "#E1F5EE"],  // green
    ["#B8781E", "#FEF3E2"],  // amber
    [s?.unreadAgencyChats ? "#EF4444" : "#0D6E56",
     s?.unreadAgencyChats ? "#FEF2F2" : "#E1F5EE"],
  ];
  ...
  const menuCards = [
    { icon: <Building2 size={14} />,     label: "Agency Profile",  desc: "Branding & info",         path: adminPath("/agency-profile"),       accentColor: "#0D6E56", bgColor: "#E1F5EE" },
    { icon: <UserPlus size={14} />,      label: "Add Maid",        desc: "Expand your roster",       path: adminPath("/add-maid"),             accentColor: "#0D6E56", bgColor: "#E1F5EE" },
    ...
    { icon: <MessageSquare size={14} />, label: "Messages",        desc: "Reply to clients",         path: adminPath("/chat-support"),         accentColor: "#0D6E56", bgColor: "#E1F5EE",
      badge: s?.unreadAgencyChats ? `${s.unreadAgencyChats} unread` : undefined, badgeAlert: !!(s?.unreadAgencyChats) },
    { icon: <Lock size={14} />,          label: "Security",        desc: "Change password",          path: adminPath("/change-password"),      accentColor: "#6B7280", bgColor: "#F8FAFC" },
    { icon: <ScrollText size={14} />,    label: "Contracts",       desc: "Employment docs",          path: adminPath("/employment-contracts"), accentColor: "#0D6E56", bgColor: "#E1F5EE" },
    ...
    { icon: <ClipboardList size={14} />, label: "Requests",        desc: "Track bookings",           path: adminPath("/requests"),             accentColor: "#6B7280", bgColor: "#F8FAFC" },
  ];

  const waMetrics = s ? [
    { label: "Sent",          value: s.whatsappMessagesSent,           sub: `${s.whatsappMessagesDelivered} delivered`, accentColor: "#0D6E56", bgColor: "#E1F5EE" },
    { label: "Read",          value: s.whatsappMessagesRead,           sub: "Messages opened",                          accentColor: "#0D6E56", bgColor: "#E1F5EE" },
    { label: "Response Rate", value: s.whatsappResponseRate,           sub: "% replied",                                accentColor: "#6B7280", bgColor: "#F8FAFC" },
    { label: "Pending",       value: s.whatsappPendingReplies,         sub: "Awaiting reply",                           accentColor: "#B8781E", bgColor: "#FEF3E2" },
    { label: "Docs / Intrvw", value: s.whatsappDocumentSubmissionRate, sub: `${s.whatsappInterviewConfirmations} confirmed`, accentColor: "#EF4444", bgColor: "#FEF2F2" },
  ] : [];
